...
function Footer() {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      response = await axios.post("/api/sponsor/contact", values);
              ...
              <Form onFinish={handleSubmit}>
                <div className="grid md:grid-cols-2 gap-x-2 gap-y-1">
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="relative mt-2 mb-6">
                        ...
                        <input
                          type="email"
                          class="bg-gray-50 border text-sm rounded-lg  block w-full ps-10 p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                  ...
                  <Form.Item
                    name="mobile"
                    rules={[
                      { required: true, message: "Please provide your mobile" },
                    ]}
                  >
                    <label
                      for="mobile"
                  ...
                  <Form.Item
                    name="message"
                    rules={[
                      { required: true, message: "Write Something for us" },
                    ]}
                  >
                    <label
                      for="mobile"
